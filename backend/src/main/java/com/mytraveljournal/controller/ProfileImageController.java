...
public class ProfileImageController {
    ...
    private static final String UPLOAD_DIR = "C:/My Files/Software Projects/MyTravelJournal/project/backend/uploads/profile-images/";
    ...
    public ResponseEntity<?> uploadProfileImage(@RequestParam("file") MultipartFile file) {
        try {
            ...
            String url = "/uploads/profile-images/" + newFileName;
